...
function botoes() {
    const listab = new Image();
    listab.src = "img/botoes.jpg";
    ctx.drawImage(listab, 0, 0, 1024, 576, 0, 0, 1024, 576);
}
...
const time = {
    ...
    desenha() {
        ...
        ctx.fillText(num, time.vdx, time.vdy);
    }
}
...
function loop () {
    if (perso1.win != true && perso2.win != true && tempoativo != false)
    {
        perso1.atualiza();
        perso2.atualiza();
        chao.desenha();
        ...
        if (perso1.ataq.anum == 1 && perso1.akey == 'b')
        {
            ...
            {
                vida2.dw = vida2.dw - (460 / 13);
                vida2.dx = vida2.dx + (460 / 13);
            }
        }
        ...
        if (perso2.ataq.anum == 1 && perso2.akey == '2')
        {
            perso2.atak1();
            ...
            {
                vida1.dw = vida1.dw - (460 / 13);
            }
        }
        if (perso2.ataq2.anum == 1 && perso2.akey == '3')
        {
            perso2.atak2();
    ...
    if(sprite1 == 1 && frame1 == 2)
    {
        perso1.ataq.anum = 1;
    }
    if(sprite1 == 2 && frame1 == 2)
    {
        perso1.ataq2.anum = 1;
    }
    ...
    if(sprite2 == 1 && frame2 == 2)
    {
        perso2.ataq.anum = 1;
    }
    if(sprite2 == 2 && frame2 == 2)
    {
        perso2.ataq2.anum = 1;
    }
